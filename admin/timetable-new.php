...
<div class="row">
   <div class="container" >
       ...
       <?php require_once('includes/nav.php'); ?>
          ...
          <form action="timetable-new.php" name="schedule_form" onSubmit="return validate_schedule_form();" method="post" >
                ...
                <label>Select Destination To</label>
                <input type="date" class="form-control add-todo" data-toggle="tooltip" title="Select Timetable Date"  name="date" data-provide="datepicker"><br>
                
              
             <label>Select Timetable Time</label>
             <div class="input-group bootstrap-timepicker timepicker">
            <input id="timepicker1" type="text" name="time" data-toggle="tooltip" title="Select Timetable Time" class="form-control input-small">
            <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
            </div>
        <br/>
 
            
              <button type="submit" class="btn btn-primary" name="add_timetable">Add Train Timetable</button>
              </form>
           <script>
           //validate form
			        ...
			        while ($row = mysqli_fetch_array($result)) {
					 ...
					 ?>
                      ...
                      <tr>
                       ...
                       <a href="timetable-new.php?deleteid=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('Delete this?')"> <span class="glyphicon glyphicon-trash"></span> </a></td>
                      </tr>
