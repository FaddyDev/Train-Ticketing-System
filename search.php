...
<?php
    if(isset($_POST['search_schedule'])){
		$search_to = $_POST['to'];
		$search_from = $_POST['from'];
		$search_date = $_POST['traveldate'];
...
<div class="container">
   <div class="row">
       ...
       <h2>Train Schedule List &raquo; Search Result</h2>
...
<br>
       ...
       <table class="table table-striped">
                    ...
                    <?php 
					$query = "SELECT * FROM view_schedule WHERE train_to_id = $search_to and train_from_id = $search_from ";
			        ...
			        while ($row = mysql_fetch_array($result)) {
					 ...
					 ?>
                      ...
                      <tr>
                       ...
                       <a href="tickets.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="View Tickets" class="btn btn-primary btn-xs" > View Tickets </a>
